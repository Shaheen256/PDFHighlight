...
namespace MyNSpace
{
    ...
    public class myLocationTextExtractionStrategy : ITextExtractionStrategy
    {
        ...
        private object _UndercontentCharacterSpacing = 0;
        private object _UndercontentHorizontalScaling = 0;
        ...
        private bool EndsWithSpace(String str)
        {
            ...
            return Convert.ToString(str.Length - 1) == " ";
        }
        ...
        private float GetStringWidth(string str, float curFontSize, float pSingleSpaceWidth, DocumentFont pFont)
        {
            ...
            foreach (char c in chars)
            {
                ...
                totalWidth += (w * curFontSize + Convert.ToSingle(this.UndercontentCharacterSpacing)) * Convert.ToSingle(this.UndercontentHorizontalScaling) / 100;
            }
        ...
        public virtual void RenderText(TextRenderInfo renderInfo)
        {
            ...
            _with1.PosLeft = renderInfo.GetDescentLine().GetStartPoint()[Vector.I2];
            _with1.PosRight = renderInfo.GetAscentLine().GetEndPoint()[Vector.I2];
